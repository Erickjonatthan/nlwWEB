...
interface FeedbackSucessStepProps{
    ...
    onFeedbackRestartSucess: () => void;
}
export function FeedbackSucessStep({ onFeedbackRestartSucess }: FeedbackSucessStepProps ) {
    return (
     <>
     <header>
     ...
     <div className="flex flex-col items-center py-10 w-[304px]">
                ...
                <button className="py-2 px-6 mt-6 bg-zinc-600 rounded-md border-transparent text-sm leading-6 hover:bg-zinc-700 transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-zinc-900 focus:ring-brand-500"
                type="button"
                    onClick={onFeedbackRestartSucess}>
                Quero enviar outro
            </button>
     </div>
